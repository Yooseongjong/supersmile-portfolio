                ...
                <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative w-full aspect-video">
                        <motion.div
                            ...
                            className="absolute inset-0 border border-white/10 rounded-xl overflow-hidden group z-10"
                        >
                            <iframe
                                className="w-full h-full object-cover"
                                src="https://www.youtube.com/embed/4KbbRQ82doU?rel=0&modestbranding=1&controls=1&vq=hd1080"
                                title="Showreel"
